...
(0, _blueTape2.default)('fetchers/clubhouse', function (t) {
  t.test('getStory returns a Promise', function (tt) {
    ...
    (0, _nock2.default)('https://api.clubhouse.io').get('/api/v2/stories/123?token=not-a-real-token').reply(200, (0, _stringify2.default)(expected));
  ...
  t.test('listUsers returns a Promise', function (tt) {
    ...
    (0, _nock2.default)('https://api.clubhouse.io').get('/api/v2/members?token=not-a-real-token').reply(200, (0, _stringify2.default)(expected));
  ...
  t.test('listProjects returns a Promise', function (tt) {
    ...
    (0, _nock2.default)('https://api.clubhouse.io').get('/api/v2/projects?token=not-a-real-token').reply(200, (0, _stringify2.default)(expected));
  ...
  t.test('createStory returns a Promise', function (tt) {
    ...
    (0, _nock2.default)('https://api.clubhouse.io').post('/api/v2/stories?token=not-a-real-token').reply(200, (0, _stringify2.default)(expected));
